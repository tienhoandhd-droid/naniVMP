-- "Tiến độ" không phải Tào Tiến Hoàn, "chung" không phải line Cân chung.
--
-- Lỗi bắt được từ execution thật (30/07): lớp phân tích viết lại câu thành
-- "Tiến độ thẩm định của nhóm hệ thống nước..." — đường dò tên người (cố ý
-- không lọc hư từ, để bắt tên một tiếng như "Hằng") vớ chữ "tiến" và gán
-- trọn 65 việc / 45 quá hạn của Tào Tiến Hoàn cho nhóm nước. Cùng câu đó,
-- chữ "chung" (trong "tiến độ chung") vớ nhầm line "Cân chung".
--
-- Sửa hai chỗ, còn lại giữ nguyên:
-- 1. Thêm 'tiến độ', 'tiến hành', 'tiến trình', 'tiến triển' vào danh sách
--    cụm-ngoại-lệ của đường dò tên người (cùng chỗ với 'hoàn thành').
--    Đánh đổi đã biết: "tiến độ của anh Tiến" sẽ không dò ra người Tiến —
--    chấp nhận, giống hệt đánh đổi sẵn có của 'hoàn thành'.
-- 2. Chữ "chung" đứng một mình không được khớp gì cả; chỉ khi câu có đủ
--    cụm "cân chung" thì line Cân chung mới được nhận.
...
begin
  ...
  loop
    ...
    -- nhiều người. "có thiết bị máy ly tâm không" từng gộp Hệ ly tâm
    -- Alfalaval với xe ô tô và tủ hấp quần áo rồi cộng thành 5 hạng mục.
    -- Cộng ba thứ chẳng liên quan gì nhau ra một con số là vô nghĩa.
    -- Thêm nhom_viec, khu_vuc, line theo đúng đề xuất của người dùng:
    -- "nhóm hệ nước" dính cả nước tinh khiết lẫn nước thải, cộng gộp
    -- thành 26 hạng mục là con số không ai dùng được. Thà hỏi lại.
