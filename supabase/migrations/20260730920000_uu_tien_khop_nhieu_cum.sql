-- =====================================================================
-- Ba chỗ vá cuối, tìm ra nhờ mở bộ câu hỏi vàng lên 109 câu
--
-- 1. LUẬT "CỤM DÀI THẮNG" NUỐT MẤT ĐÁP ÁN ĐÚNG.
--    "kho lạnh trong kho nguyên liệu ra sao" — cụm "nguyen lieu" (11 ký
--    tự) dài hơn "kho lanh" (8) nên thắng, kéo theo hàng chục thiết bị
--    có chữ nguyên liệu, vượt trần 25 và cả nhóm bị bỏ.
--    Sửa: ưu tiên giá trị khớp NHIỀU CỤM khác nhau nhất, rồi mới tới độ
--    dài. Đúng thiết bị đó khớp cả hai cụm, các thiết bị khác chỉ một.
--
-- 2. MÃ VIẾT HOA BA KÝ TỰ BỊ CHẶN OAN.
--    Vừa thêm luật "tên thiết bị/line phải khớp bằng tiếng >= 4 ký tự"
--    thì BFS, HVAC, HPLC chết theo. Chúng là MÃ chứ không phải từ tiếng
--    Việt. Sửa: viết HOA trong câu gốc thì 3 ký tự vẫn đủ đặc hiệu.
--
-- 3. TÊN NGƯỜI HAI KÝ TỰ.
--    "công việc của My thế nào" — "My" hai ký tự, dưới ngưỡng 3 nên
--    không dò. Hạ ngưỡng riêng cho đường tên người có dấu.
--
-- Kèm: thêm "hoan" vào hư từ (hoàn thành / Hoàn thiện - XSX vơ nhầm cả
-- line lẫn người Tào Tiến Hoàn; tên riêng vẫn bắt được qua đường có dấu).
-- =====================================================================
...
begin
  ...
  for r in
    ...
    where x.so_cum = d.mc or x.loai = 'nguoi'
    group by x.loai
