-- =====================================================================
-- Dính nhiều thiết bị khác họ thì HỎI LẠI, đừng cộng gộp
--
-- Câu thật vừa sai: "có thiết bị máy ly tâm không? tìm cho tôi thiết bị
-- liên quan" trả về 23 hạng mục, 9 quá hạn, hai người phụ trách.
-- Sự thật: đúng MỘT thiết bị "Hệ ly tâm Alfalaval", 2 hạng mục, một
-- người phụ trách là Lê Xuân Đức.
--
-- Hàm khoanh ra BA đối tượng rồi cộng gộp: Hệ ly tâm Alfalaval + Thẩm
-- định phương tiện vận chuyển xe ô tô + Tủ hấp tiệt trùng quần áo. Chữ
-- "liên QUAN" trong câu hỏi khớp "QUẦN áo", và mấy chữ khác kéo theo xe
-- ô tô. Cộng ba thứ chẳng liên quan gì nhau ra một con số là vô nghĩa.
--
-- Luật "dính nhiều thì giấu số và hỏi lại" trước đây chỉ áp cho NGƯỜI.
-- Nay áp cho cả TÊN THIẾT BỊ và MÃ — cùng một lý lẽ: gộp những thứ khác
-- họ vào một con số thì con số đó không nói lên điều gì, mà lại nghe rất
-- chắc chắn.
--
-- Người dùng nói đúng: thiếu thông tin thì phải HỎI NGƯỢC LẠI. Trước đây
-- hàm không hỏi lại vì nó tưởng mình đã khoanh xong — nó khoanh được 3
-- giá trị nên tự tin cộng luôn.
-- =====================================================================
...
begin
  ...
  loop
    ...
    if r.loai in ('nguoi', 'ten_doi_tuong', 'ma') and r.sl > 1 then
