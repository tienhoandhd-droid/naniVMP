-- =====================================================================
-- Dashboard trả thêm HẠN THẨM ĐỊNH (deadline_validation)
--
-- Cột này có dữ liệu cho 455/461 hạng mục nhưng rpc_get_vmp_dashboard
-- không trả về, nên hộp "Cập nhật tiến độ" và trang Cảnh báo phải hiện
-- "Không có thông tin" ở mốc thẩm định, còn timeline chi tiết thì thiếu
-- đúng cái mốc nặng nhất. Thêm 'dl_tham_dinh' vào _raw; phần còn lại của
-- hàm giữ nguyên như bản đang chạy.
-- =====================================================================
