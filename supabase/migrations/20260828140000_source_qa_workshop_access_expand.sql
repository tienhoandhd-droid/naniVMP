  ...
  for v_expected in
    select * from (values
      ('profiles', 12,
       ...
       2, 'f3e424475b0c3ce07dc3aafeb09a815e8f4950944c0b8468e3238cd88383531e',
      ...
      ('vmp_performers', 21,
       ...
       1, 'bc3bfde8410a01281ef59cf844716d13369251c53d633d4a6cf6bd14b03110e0',
       'ebe40005564f63ea0c8ed2541d5fc9a27b432ff5e398e9c52c50e1214bc4f663'),
      ('vmp_source_objects', 38,
       ...
       1, '59f2ec3f76063343bf8758df69a6d6c3ad79b346d349a632d348e417858ceb21',
       'ebe40005564f63ea0c8ed2541d5fc9a27b432ff5e398e9c52c50e1214bc4f663'),
      ('vmp_plan_items', 59,
  ...
  loop
    ...
    select count(policy_row.*),
           encode(extensions.digest(convert_to(coalesce(string_agg(format(
             ...
             policy_row.polpermissive, array_to_string(array(
               select coalesce(role.rolname, 'public')
               from unnest(policy_row.polroles) policy_role(oid)
               left join pg_roles role on role.oid = policy_role.oid
