-- =====================================================================
-- Trả luôn NGƯỜI PHỤ TRÁCH và MỐC THỜI GIAN của nhóm
--
-- Câu thật vừa sai: "thời gian thẩm định hệ nước, người phụ trách là ai".
-- Vali trả lời 20 hạng mục / 6 xong / 8 quá hạn / Tôn Nữ Thiện My.
-- Sự thật: 24 hạng mục / 9 xong / 6 quá hạn / Nguyễn Thị Hương (24/24).
-- Sai cả năm con số lẫn tên người.
--
-- Truy ra thì hàm đếm ĐÚNG 24, nhưng nó KHÔNG trả về người phụ trách và
-- không trả về mốc thời gian — đúng hai thứ câu hỏi đang hỏi. Mô hình
-- thiếu dữ liệu nên đi vớ tên ở bảng xếp hạng toàn nhà máy (Tôn Nữ Thiện
-- My đứng đầu bảng đó), rồi bịa nốt mấy con số cho khớp câu văn.
--
-- Lại đúng một bài học cũ: mô hình thiếu số thì nó không im, nó vớ đại.
-- Cách chữa duy nhất ăn là ĐƯA ĐỦ những gì câu hỏi cần, ngay trong ô
-- kết luận đã chốt.
-- =====================================================================
