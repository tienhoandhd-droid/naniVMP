-- =====================================================================
-- Ba lỗ hở tìm ra ở đợt 3 của bộ câu hỏi vàng (161 câu)
--
-- 1. CÂU HỎI VỀ CHÍNH HỆ THỐNG bị vơ nhầm tên riêng.
--    "dữ LIỆU cập nhật lần cuối"    -> Nguyên liệu sinh phẩm
--    "CHUYỆN lượt trước"            -> Thẩm định phương tiện vận chuyển
--    "LINE xịt thế nào"             -> Thiết bị khác line B2 + B3
--    Cùng một lớp lỗi với đợt trước, chỉ khác bộ chữ. Thêm vào hư từ.
--
-- 2. TÊN MỘT TIẾNG NGẮN BỊ CHẶN OAN.
--    Luật "tên thiết bị/line phải >= 4 ký tự" giết luôn line "Xịt" —
--    vốn là NGUYÊN CẢ TÊN chứ không phải mẩu của tên. Nay khớp trọn vẹn
--    cả tên thì nhận, dù ba ký tự. Vẫn chặn "kem" vì nó chỉ là một mẩu
--    của "Kem/Gel (X1)".
--
-- 3. CÂU SO SÁNH MẤT ĐỐI TƯỢNG THỨ HAI.
--    "nhóm tank với nhóm nồi hấp cái nào gấp hơn" chỉ ra nồi hấp: nó
--    khớp hai cụm ("noi hap", "hap") còn tank chỉ khớp một, nên luật
--    ưu-tiên-nhiều-cụm loại mất tank. Mà tank khớp bằng một cụm nồi hấp
--    KHÔNG khớp — đó chính là dấu hiệu câu hỏi nhắc hai đối tượng. Nay
--    giữ cả hai, để mô hình còn so sánh được.
-- =====================================================================
