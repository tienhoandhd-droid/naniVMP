-- =====================================================================
-- Luật hỏi-lại áp cho cả nhóm việc, khu vực và line
--
-- Đúng đề xuất của người dùng. "nhóm hệ thống nước đến đâu rồi" dính cả
-- Hệ thống nước tinh khiết (24 hạng mục) lẫn Hệ thống nước thải (2), cộng
-- gộp thành 26 — một con số không ai dùng được, vì hai hệ đó khác nhau
-- hoàn toàn về bản chất và về mức ảnh hưởng chất lượng.
--
-- Trước đây luật hỏi-lại chỉ áp cho người, tên thiết bị và mã. Nay áp cho
-- cả nhom_viec, khu_vuc, line — mọi loại mà gộp lại thì mất nghĩa.
--
-- Loại DUY NHẤT còn được gộp là loai_td (IQ/OQ/PQ...): hỏi "IQ còn bao
-- nhiêu" thì gộp mọi IQ lại là đúng ý, vì chúng cùng một bản chất.
-- =====================================================================
