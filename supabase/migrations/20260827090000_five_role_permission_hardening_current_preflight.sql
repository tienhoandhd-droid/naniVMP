...
begin
  ...
  if v_local then
    ...
    v_expected_blocker_count := 479;
    v_expected_blocker_digest := '99a46e1c1a96ea8ea612056d6f596af3';
    v_expected_warning_count := 14;
    v_expected_warning_digest := '7bc0aa25501a745ddc161e13ef5dab9a';
  end if;
