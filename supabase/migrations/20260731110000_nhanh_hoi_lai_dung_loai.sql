-- =====================================================================
-- Nhánh "hỏi lại" ghi cứng loai='nguoi' cho cả thiết bị
--
-- Vừa mở luật hỏi-lại cho tên thiết bị và mã, nhưng nhánh đó viết cứng
-- 'loai', 'nguoi' từ hồi chỉ áp cho người. Hệ quả: câu "máy đóng túi đến
-- đâu" khoanh đúng hai máy (Máy đóng túi và Máy Đóng Túi Bột) và hỏi lại
-- đúng, nhưng lại tự nhận mình đang nói về NGƯỜI — bộ chấm bắt được ngay
-- ở câu 166.
--
-- Chính là lý do cần bộ câu hỏi vàng: một chữ hardcode sót lại sau khi mở
-- rộng luật, mắt người rà không thấy.
-- =====================================================================
