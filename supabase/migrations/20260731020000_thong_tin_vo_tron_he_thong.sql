-- =====================================================================
-- "cho tôi THÔNG TIN..." vơ trọn mọi nhóm "Hệ THỐNG"
--
-- Câu thật vừa sai: "cho tôi thông tin thẩm định xe hơi" trả về 136
-- hạng mục, 49 quá hạn, kèm cả bảng phân công ba người.
-- Sự thật: xe hơi có ĐÚNG MỘT hạng mục — "Thẩm định phương tiện vận
-- chuyển: xe ô tô".
--
-- Hai chỗ hỏng cùng lúc, cùng một gốc là bỏ dấu tiếng Việt:
--   · "THÔNG tin"  bỏ dấu thành "thong"  = "Hệ THỐNG"  -> vơ 5 nhóm
--   · "xe HƠI"     bỏ dấu thành "hoi"    = "HƠI tinh khiết"
--
-- Chỗ thứ nhất nguy hơn nhiều vì "cho tôi thông tin..." là cách mở đầu
-- câu hỏi phổ biến bậc nhất — nghĩa là rất nhiều câu hỏi khác cũng đang
-- âm thầm bị vơ nhầm y như vậy mà chưa ai để ý.
--
-- Thêm "thong", "tin" và mấy hư từ mở đầu câu vào danh sách bỏ qua.
-- Vẫn an toàn: hỏi "hệ thống tank" thì "tank" vẫn khoanh đúng, hỏi "hệ
-- thống nước" thì "nuoc" vẫn khoanh đúng.
-- =====================================================================
...
-- "xe hơi", "ô tô", "xe tải" — người ta gọi thế, trong sổ ghi là
-- "Thẩm định phương tiện vận chuyển: xe ô tô"
insert into public.vmp_ai_bi_danh (bi_danh, loai, gia_tri, ghi_chu) values
('xe hoi',      'ten_doi_tuong', 'Thẩm định phương tiện vận chuyển: xe ô tô', 'Cách gọi dân dã'),
('o to',        'ten_doi_tuong', 'Thẩm định phương tiện vận chuyển: xe ô tô', null),
('xe tai',      'ten_doi_tuong', 'Thẩm định phương tiện vận chuyển: xe ô tô', null),
('phuong tien', 'ten_doi_tuong', 'Thẩm định phương tiện vận chuyển: xe ô tô', null),
('van chuyen',  'ten_doi_tuong', 'Thẩm định phương tiện vận chuyển: xe ô tô', null)
on conflict (bi_danh, loai, gia_tri) do nothing;

-- Nhét vào bộ chấm để lỗi này không quay lại
insert into public.vmp_ai_cau_hoi_vang (cau_hoi, mong_doi, nhom, ghi_chu) values
('cho tôi thông tin thẩm định xe hơi',
 '{"loai":"ten_doi_tuong","gia_tri":"Thẩm định phương tiện vận chuyển: xe ô tô"}', 'doi_tuong',
 'Từng trả 136 hạng mục thay vì 1 — "thông tin" vơ trọn "Hệ thống"'),
('cho tôi thông tin nhóm tank',
 '{"loai":"nhom_viec","gia_tri":"Hệ thống tank"}', 'doi_tuong',
 'Có chữ "thông tin" nhưng vẫn phải khoanh đúng nhóm tank'),
('cho tôi thông tin về hệ thống nước',
 '{"loai":"nhom_viec","gia_tri":"Hệ thống nước tinh khiết, nước cất"}', 'doi_tuong',
 'Có cả "thông tin" lẫn "hệ thống"'),
('xe ô tô thẩm định đến đâu',
 '{"loai":"ten_doi_tuong","gia_tri":"Thẩm định phương tiện vận chuyển: xe ô tô"}', 'doi_tuong', null),
('thông tin về khu B3',
 '{"loai":"khu_vuc","gia_tri":"B3"}', 'doi_tuong', 'Mở đầu bằng "thông tin"')
