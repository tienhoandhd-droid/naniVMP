-- =====================================================================
-- 20260707130000_dashboard_raw_dept_text.sql
-- Bổ sung CHỮ GỐC "Bộ phận quản lý" (values_json index 5) vào _raw để
-- frontend tách 1 hạng mục thành NHIỀU bộ phận (vd "RD, QLCL, XSX" =
-- RD + QA + QC + Xưởng SX). Chỉ ĐỌC thêm, tương thích ngược.
-- =====================================================================
    ...
    'activities', (
      SELECT COALESCE(jsonb_agg(jsonb_build_object(
        ...
        '_raw', jsonb_build_object(
          ...
          'qa', i.owner_name,
          'bo_phan', i.obj_dept,
          'bo_phan_goc', rs.bo_phan_goc,          -- MỚI: chữ gốc "Bộ phận quản lý"
