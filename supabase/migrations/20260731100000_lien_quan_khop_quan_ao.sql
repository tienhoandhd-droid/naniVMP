-- =====================================================================
-- "liên QUAN" khớp "QUẦN áo"
--
-- Sau khi chặn cộng gộp, câu "có thiết bị máy ly tâm không? tìm cho tôi
-- thiết bị liên quan" vẫn dính ba đối tượng. Truy tiếp thì chữ "liên
-- QUAN" bỏ dấu thành "quan", trùng khít "QUẦN áo" trong "Tủ hấp tiệt
-- trùng quần áo".
--
-- Cùng một lớp lỗi với "thông tin" khớp "Hệ thống" và "kém" khớp
-- "Kem/Gel" — bỏ dấu tiếng Việt làm hai chữ khác nghĩa thành giống nhau.
-- Mỗi lần gặp thì thêm đúng chữ đó vào danh sách hư từ.
--
-- Vẫn an toàn: ai hỏi "tủ hấp quần áo" thì cụm hai tiếng "quan ao" vẫn
-- khớp bình thường, chỉ tiếng "quan" đứng một mình mới bị bỏ.
-- =====================================================================
