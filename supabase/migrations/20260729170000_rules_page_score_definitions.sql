-- =====================================================================
-- Bổ sung MÔ TẢ và VÍ DỤ cho từng mức điểm vào tab "Luật đang áp dụng".
--
-- Trước đây trang web chỉ hiện Cao/Trung bình/Thấp = 3/2/1, không nói
-- thiết bị nào rơi vào mức nào. Chính chỗ mù đó khiến lỗi "LAF cân bị
-- coi như cái cân" nằm im mà không ai soi ra. Giờ ghi rõ tiêu chí và
-- ví dụ để QA đối chiếu được ngay trên web.
-- =====================================================================
