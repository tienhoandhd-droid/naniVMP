...
export const NAV_ITEMS = [
  ...
  { id: "source", label: "Danh mục nguồn", icon: Pencil, group: "monitor" },
...
export const NAV_SUBS = {
  ...
  source: "5 danh mục nguồn (thiết bị · quy trình · kho · hệ thống phụ trợ · vận chuyển) — nhập liệu trực tiếp, thay cho Google Sheet",
