...
import { CLS, DEPTS, CRIT, MONTHS, PHASE_COLOR, STAGES, vmpToday } from "../constants/vmp.js";
...
export default function TimelineView({ acts }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      <Card variant="strong">
        <CardTitle icon={GanttChartSquare} sub={`${filtered.length} hạng mục · Năm ${vmpToday().getFullYear()}`}>🏁 Đường đua thẩm định VMP</CardTitle>
