...
import { CLS, CRIT, WL_MONTHS, WL_QUARTERS, CAP_MONTH, CAP_HOSO_MONTH, VMP_TODAY } from "../constants/vmp.js";
        ...
        <div style={{ overflowX: "auto" }} className="vmp-scroll">
          <table style={{ borderCollapse: "separate", borderSpacing: 5, minWidth: scope === "month" ? 880 : 440 }}>
            <thead><tr>
              ...
              {cols.map((c, ci) => { const isNow = scope === "month" && ci === VMP_TODAY.getMonth(); return <th key={c} style={{ fontSize: 11, fontWeight: 800, color: isNow ? C.pinkText : C.plumSoft, padding: "0 4px 8px", minWidth: 54 }}>{c}{isNow ? " •" : ""}</th>; })}
