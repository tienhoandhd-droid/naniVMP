...
export default function StaffDirectoryPanel({
  ...
  useEffect(() => {
    ...
    /* Ô rỗng KHÔNG có nghĩa "chưa gõ gì thì đừng tìm" — server
       ...
       rỗng bị chặn ở đây cùng với ô 1 ký tự, nên danh bạ chỉ hiện ô tìm
       trống trơn và biểu mẫu rỗng — không có gì gợi ý "đã có sẵn những ai".
       Chỉ còn chặn đúng 1 ký tự (quá ngắn, khớp lan man). */
