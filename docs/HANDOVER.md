...
- Token webhook `x-vmp-sync-token` hiện là giá trị yếu và **đã lộ trong repo** (`n8n/apps-script/vmp-sheet-sync.gs`). Người tiếp nhận nên: đổi token mới trong n8n (node CONFIG3/Header Auth) + cập nhật Apps Script, và từ nay để token ngoài code.
