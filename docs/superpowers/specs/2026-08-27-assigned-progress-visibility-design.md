...
- Luồng E2E chéo màn hình của đợt này bắt đầu từ hạng mục chưa có QA phụ trách: Quản lý QA thêm người bằng Dữ liệu nguồn hiện có, lưu thành công, rồi hạng mục phải xuất hiện trong Cập nhật tiến độ của người đó. Không thay đổi giao diện, RPC lưu, dữ liệu hoặc quyền truy cập của Dữ liệu nguồn trong đợt này; hành vi thay/xóa người của writer Dữ liệu nguồn hiện có nằm ngoài phạm vi.
...
- Tập quyền cập nhật phản ánh phân công hiệu lực; E2E chéo màn hình xác minh phân công được luồng QA phụ trách hiện có tạo khi thêm người. Đợt này không thay đổi contract lưu Dữ liệu nguồn.
...
- E2E phải kiểm request/payload thật của hai màn cho luồng thêm QA phụ trách từ trạng thái chưa có người, không chỉ gọi trực tiếp hàm lọc frontend. Các fixture không được phân công vẫn phải chứng minh hạng mục không xuất hiện.
